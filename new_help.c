...
void new_help_help(vars_t *vars)
{
	...
	if (_strcmp(vars->array_tokens[1], "help") == 0)
	{
...
void new_help_exit(vars_t *vars)
{
	...
	if (_strcmp(vars->array_tokens[1], "exit") == 0)
	{
...
void new_help_cd(vars_t *vars)
{
	...
	if (_strcmp(vars->array_tokens[1], "cd") == 0)
	{
...
void new_help_env(vars_t *vars)
{
	...
	if (_strcmp(vars->array_tokens[1], "env") == 0)
	{
